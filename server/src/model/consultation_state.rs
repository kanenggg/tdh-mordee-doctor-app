...
mod tests {
    ...
    fn test_appointment_status_mapping() {
        assert_eq!(
            serde_json::to_value(ConsultationState::TimeslotReserved.to_appointment_status())
                .unwrap()["__type"],
            "Reserved"
        );
        assert!(matches!(
        ...
        assert_eq!(
            serde_json::to_value(ConsultationState::ConsultationCancelled.to_appointment_status())
                .unwrap()["__type"],
            "Cancelled"
        );
        assert_eq!(
            serde_json::to_value(ConsultationState::ReservationCancelled.to_appointment_status())
                .unwrap()["__type"],
            "Cancelled"
        );
        assert!(matches!(
