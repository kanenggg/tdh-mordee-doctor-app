CREATE TABLE IF NOT EXISTS consultation_schedule (
    ...
    schedule_config jsonb NOT NULL DEFAULT '{"specificDate":[],"dayOfWeek":{}}'::jsonb,
    created_at timestamptz NOT NULL DEFAULT now(),
    updated_at timestamptz NOT NULL DEFAULT now(),
    PRIMARY KEY (doctor_id, biz_unit_id)
);

CREATE INDEX IF NOT EXISTS idx_consultation_schedule_doctor_id
...
CREATE INDEX IF NOT EXISTS idx_consultation_instant_doctor_id
